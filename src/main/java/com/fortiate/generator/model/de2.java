...
public class de2 {
	...
	private String calculate(String network)
	{
		...
		HashMap<String, String> networkBIN;
		networkBIN = new HashMap<String, String>();

		// valuating
		networkBIN.put("rupay", "666666");
		networkBIN.put("mastercard", "55555");
		networkBIN.put("visa", "444444");
		
		HashMap<String, Integer> networkL;
		networkL = new HashMap<String, Integer>();

		networkL.put("amex", 15);

		
		//https://gist.github.com/josefeg/5781824
		
		return generate(((networkBIN.get(network) == null) ? "222222" : networkBIN.get(network)), ((networkL.get(network) == null) ? 16 : networkL.get(network)));
